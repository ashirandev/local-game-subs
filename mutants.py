...
MUTANTS = [
    ...
    ("overlay.py", "def __init__(self, url, font=None, size=28, sample=SAMPLE, in_capture=False",
     "def __init__(self, url, font=None, size=28, sample=SAMPLE, in_capture=True",
    ...
    ("server.py", "    if len(projectors) == 1:", "    if False:",
